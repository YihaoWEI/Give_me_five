...
Page({
  data: {
    titleone: '4. 如果要开一家公司，你倾向于选下面的谁当合伙人？（单选）',
    percentage: '40',
    items: [
      { name: '推理性', value: '精于分析的推理者（Analyzer）' },
      { name: '扮演性', value: '擅长交际的圆滑者（Socializer）' },
      { name: '竞技性', value: '擅长作战的竞技者（Athletics）' },
      { name: '团队性', value: '擅长团建的规划师（Friends）' },
      { name: '策略性', value: '擅长谋略的军师（Adviser）' },
    ],
    checknum1: false,
    checknum2: false,
    checknum3: false,
  ...
  nextpage: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/question5/question5?title=question5'
    })
  }
})