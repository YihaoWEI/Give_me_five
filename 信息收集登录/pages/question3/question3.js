...
Page({
  data: {
    titleone: '3. 哪些休闲活动你看了会眼前发亮？（多选）',
    percentage: '26',
    items: [
      { name: '推理性', value: '密室逃脱（Room Escape）' },
      { name: '扮演性', value: 'Cosplay' },
      { name: '竞技性', value: '篮球（Basketball）' },
      { name: '团队性', value: 'Party' },
      { name: '策略性', value: '棋牌（Chess）' },
    ],
    checknum1: false,
    checknum2: false,
    checknum3: false,
  ...
  nextpage: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/question4/question4?title=question4'
    })
  }
})